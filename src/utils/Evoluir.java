...
public class Evoluir {
	...
	public void aumentarPontos(Animal animal, Partida partida, int pontos, DAO dao) {
		...
		if(animal.getTotalPontos() >= (animal.getPontosEvoluir()+pontos)) {	//verifica se tem pontos para evoluir
			...
			evoluir(animal, partida, dao);	//evolui
	...
	public void evoluir(Animal animal, Partida partida, DAO dao) {
