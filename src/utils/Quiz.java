...
public class Quiz extends JFrame{
	...
	public Quiz() {
		ImageIcon icone = new ImageIcon(getClass().getResource("/images/fundo/quiz.png"));
		Image redimensionada = icone.getImage().getScaledInstance(600, 600, Image.SCALE_DEFAULT);
		JLabel fundo = new JLabel(new ImageIcon(redimensionada));
		setSize(600, 600);
        add(fundo);
