	            ...
	            String casaQuiz = gui.getCelula(animal.getX()).getQuiz();
	      		...
	      		if (presaCelula != null) {
	            	...
	            	if(nivelAnimal > nivelPresa) {
	            		if(animal.getNivel() == 1 ) {
	            			gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " consumiu um alimento nível " + nivelPresa + "! " + "+" + points + " pontos!", 3000, new Color(102, 255, 102), 2);
	            			delay = 3000;
	            		}
	            		else {
			            	gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " capturou uma presa nível " + nivelPresa + "! " + "+" + points + " pontos!", 3000 ,new Color(102, 255, 102), 2);
			            	delay = 3000;
	            		}
	            		...
	            		if(nivelPresa == 1 ) {
	            			gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " não conseguiu consumir o alimento. Nivel do Anímal: " + nivelAnimal +" / Nível do Alimento: " + nivelPresa, 3000, new Color(102, 255, 102), 2);
	            			delay = 3000;
	            		}
	            		else {
	            			gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " não conseguiu capturar a presa. Nivel do Anímal: " + nivelAnimal +" / Nível da Presa: " + nivelPresa, 3000, new Color(102, 255, 102), 2);
	            			delay = 3000;
	            		}
	      		...
	      		//checagem de casa com predador
	            	...
	            	if(animal.getTotalPontos() == 0) {
	            		gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " foi capturado, porém não tinha nada a perder...", 3000, new Color(255, 0, 0), 2);
	            		delay = 3000;	
	            	}
	            	
	            	else if(animal.getTotalPontos() <= 5) {
	            		animal.setTotalPontos(0);
	            		gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " foi capturado e leveram tudo o que tinha..", 3000, new Color(255, 0, 0), 2);
	            		delay = 3000;
	            	}
	            	
	            	else {
		            	animal.setTotalPontos(animal.getTotalPontos() - 5);
		            	gui.mostrarMensagemTemporaria("O jogador " + jogador.getJogador() + " foi capturado. -5 pontos...", 3000, new Color(255, 0, 0), 2);
		            	delay = 3000;
	            	}
	      		...
	      		// casa de quiz
	      		    ...
	      		    TelaQuiz quiz = new TelaQuiz(gui); 
